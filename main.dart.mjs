...
_1599: x0 => x0.load(),
_1600: (x0,x1) => x0.removeAttribute(x1),
_1601: x0 => x0.load(),
_1602: (x0,x1) => x0.createElement(x1),
_1603: (x0,x1) => x0.end(x1),
_1605: x0 => x0.play(),
_1606: x0 => x0.pause(),
...
_1810: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
_1811: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
...
_1833: (x0,x1) => x0.test(x1),
_1834: (x0,x1) => x0.exec(x1),
_1835: (x0,x1) => x0.exec(x1),
_1836: x0 => x0.pop(),
_1840: (x0,x1,x2) => x0[x1] = x2,
_1842: o => o === undefined,
_1843: o => typeof o === 'boolean',
_1844: o => typeof o === 'number',
_1846: o => typeof o === 'string',
_1849: o => o instanceof Int8Array,
_1850: o => o instanceof Uint8Array,
_1851: o => o instanceof Uint8ClampedArray,
_1852: o => o instanceof Int16Array,
_1853: o => o instanceof Uint16Array,
_1854: o => o instanceof Int32Array,
_1855: o => o instanceof Uint32Array,
_1856: o => o instanceof Float32Array,
_1857: o => o instanceof Float64Array,
_1858: o => o instanceof ArrayBuffer,
_1859: o => o instanceof DataView,
_1860: o => o instanceof Array,
_1861: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
_1863: o => {
            const proto = Object.getPrototypeOf(o);
            return proto === Object.prototype || proto === null;
          },
_1864: o => o instanceof RegExp,
_1865: (l, r) => l === r,
_1866: o => o,
_1867: o => o,
_1868: o => o,
...
_1870: o => o.length,
_1873: (o, i) => o[i],
_1874: f => f.dartFunction,
_1875: l => arrayFromDartList(Int8Array, l),
_1876: (data, length) => {
...
_1877: l => arrayFromDartList(Uint8ClampedArray, l),
_1878: l => arrayFromDartList(Int16Array, l),
_1879: l => arrayFromDartList(Uint16Array, l),
_1880: l => arrayFromDartList(Int32Array, l),
_1881: l => arrayFromDartList(Uint32Array, l),
_1882: l => arrayFromDartList(Float32Array, l),
_1883: l => arrayFromDartList(Float64Array, l),
_1884: (data, length) => {
...
_1885: l => arrayFromDartList(Array, l),
_1886:       (s, length) => {
        if (length == 0) return '';
...
_1895: (o, p) => o[p],
_1896: (o, p, v) => o[p] = v,
_1897: (o, m, a) => o[m].apply(o, a),
_1899: o => String(o),
_1900: (p, s, f) => p.then(s, f),
_1901: s => {
      if (/[[\]{}()*+?.\\^$|]/.test(s)) {
          s = s.replace(/[[\]{}()*+?.\\^$|]/g, '\\$&');
      }
...
_2708: x0 => x0.error,
_2709: (x0,x1) => x0.src = x1,
_2710: x0 => x0.src,
_2717: (x0,x1) => x0.preload = x1,
_2719: x0 => x0.buffered,
_2722: (x0,x1) => x0.currentTime = x1,
_2723: x0 => x0.currentTime,
_2724: x0 => x0.duration,
_2728: (x0,x1) => x0.playbackRate = x1,
_2741: (x0,x1) => x0.volume = x1,
_2754: x0 => x0.code,
_2826: x0 => x0.length,
_3761: () => globalThis.window,
_4100: x0 => x0.localStorage,
_4541: x0 => x0.length,
_8737: () => globalThis.document
    };
